...
export class TechnologyService {
     ...
     * @throws ApiError
     */
    public static v1GetTechnology(
        uid: string,
    ): CancelablePromise<TechnologyFullResponse | Error> {
     ...
     * @throws ApiError
     */
    public static v1PageTechnology(
        pageNumber?: number,
        pageSize?: number,
    ): CancelablePromise<TechnologyBaseResponse | Error> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static v1SearchTechnology(
        pageNumber?: number,
        pageSize?: number,
        sort?: string,
        formData?: any,
    ): CancelablePromise<TechnologyBaseResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/v1/rest/technology/search',
            query: {
     ...
     * @throws ApiError
     */
    public static v2GetTechnology(
        uid: string,
    ): CancelablePromise<TechnologyV2FullResponse | Error> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static v2PageTechnology(
        pageNumber?: number,
        pageSize?: number,
    ): CancelablePromise<TechnologyV2BaseResponse | Error> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static v2SearchTechnology(
        pageNumber?: number,
        pageSize?: number,
        sort?: string,
        formData?: any,
    ): CancelablePromise<TechnologyV2BaseResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/v2/rest/technology/search',
            query: {
